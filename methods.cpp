...
int Groceryque ::enqueue(Customer *a)
...
void Groceryque::Product ::readFile()
...
Groceryque::Product Groceryque::Product :: operator* (int quantity)
...

{
...

    {
        ...
        cout << "\nWould you like to provide any reviews to improve our store services?(y/n)\n";
...
Customer Customer :: operator+= (Groceryque::Product p)
...
void Customer :: display(Groceryque::Product* p)
...

{
...

    {
        ...
        cout << "Sorry!! Stacks of Delivery Boys is full :(\n";
