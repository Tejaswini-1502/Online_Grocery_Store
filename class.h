...

{
    ...
    public:
        ...
        friend void allocateJob(Groceryque &g, DeliveryBoys &d1, DeliveryBoys &d2, DeliveryBoys &d3);
    ...
    public:
        ...
        Customer operator+=(Groceryque::Product);
        ...
        void display(Groceryque::Product *);



        friend class Groceryque;
    ...
    void allocateJob(Groceryque &g, DeliveryBoys &d1, DeliveryBoys &d2, DeliveryBoys &d3);
